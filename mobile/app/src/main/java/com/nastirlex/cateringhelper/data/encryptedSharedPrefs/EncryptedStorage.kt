...
import com.nastirlex.cateringhelper.utils.Constants.CUISINES_KEY
import com.nastirlex.cateringhelper.utils.Constants.INT_DEFAULT_VALUE
import com.nastirlex.cateringhelper.utils.Constants.IS_VEGETARIAN_DEFAULT_VALUE
import com.nastirlex.cateringhelper.utils.Constants.IS_VEGETARIAN_KEY
import com.nastirlex.cateringhelper.utils.Constants.LABEL_KEY
import com.nastirlex.cateringhelper.utils.Constants.MAX_PRICE_KEY
import com.nastirlex.cateringhelper.utils.Constants.MIN_PRICE_KEY
import com.nastirlex.cateringhelper.utils.Constants.RATING_KEY
import com.nastirlex.cateringhelper.utils.Constants.STRING_DEFAULT_VALUE
import com.nastirlex.cateringhelper.utils.Constants.UNWANTED_INGREDIENTS_KEY
...
class EncryptedStorage @Inject constructor(@ApplicationContext context: Context) {
    ...
    fun getLabel(): String =
        sharedPreferences.getString(LABEL_KEY, STRING_DEFAULT_VALUE).toString()
}